...
Option (A):\\
\begin{align}
    \mathcal{L}\{\cos(at)\}&=\frac{s}{s^2+a^2}\tag{From equation \eqref{eq:laplacecos}}
\end{align}\bigskip\\
\begin{center}
...
Option (B):
\begin{align}
    \mathcal{L}\{\sin\brak{at}\}&=\frac{a}{s^2+a^2}\tag{From equation \eqref{eq:laplacesin}}
\end{align}\bigskip\\\\\\
Option (C):\\
\begin{align}
    \mathcal{L}\{\sinh\brak{at}\}&=\frac{a}{s^2-a^2}\tag{From equation \eqref{eq:laplacesinh}}
\end{align}
Option (D):\\
\begin{align}
    \mathcal{L}\{\cosh\brak{at}\}&=\frac{s}{s^2-a^2}\tag{From equation \eqref{eq:laplacecosh}}
\end{align}
