...
\large\underline{Python Implementation } \href{https://github.com/Chamarthikrishnamadhur/EE-Projects/blob/main/codes/Probability(AGGATE2025).py}{Click here to go to the github code page}\medskip\\
...
\large \underline{{Python Implementation }}\href{https://github.com/Chamarthikrishnamadhur/EE-Projects/blob/main/codes/echelon.py}{Click here to go to the github code page}\\
...
\large\underline{{Python Implementation  }}\href{https://github.com/Chamarthikrishnamadhur/EE-Projects/blob/main/codes/Sorter.py}{Click here to go to the github code page}\medskip\\
...
\large\underline{{Python Implementation }}\href{https://github.com/Chamarthikrishnamadhur/EE-Projects/blob/main/codes/gp.py}{Click here to go to the github code page}\\
...
\large\underline{{Python Implementation }}\href{https://github.com/Chamarthikrishnamadhur/EE-Projects/blob/main/codes/Plotting\%20limit.py}{Click here to go to the github code page}\bigskip\\
...
Applying the laplace transform:\\
 ...
 \end{align}
Finding laplace transform of $e^x$:\\
\begin{align}
...
\begin{align}
    ...
    y&=1.110
\end{align}
\large\underline{{Python Implementation }}\href{https://github.com/Chamarthikrishnamadhur/EE-Projects/blob/main/codes/diff_eq.py}{Click here to go to the github code page}\\
